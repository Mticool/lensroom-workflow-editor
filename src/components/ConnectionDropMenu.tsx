...
export function ConnectionDropMenu({
  ...
  const handleTypeLabel = handleType === "image" ? "изображения" : "текста";
    ...
    >
      ...
      <div className="px-2 py-1.5 border-t border-neutral-700 flex items-center justify-between">
        <span className="text-[9px] text-neutral-500">
          <kbd className="px-1 py-0.5 bg-neutral-700 rounded text-[8px]">↑↓</kbd> навигация
        </span>
        <span className="text-[9px] text-neutral-500">
          <kbd className="px-1 py-0.5 bg-neutral-700 rounded text-[8px]">↵</kbd> выбрать
        </span>
      </div>
    </div>
  );
